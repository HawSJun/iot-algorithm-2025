...
- 빅오 표기법(빠른 순)
    ...
    - $O(log n)$ : 단순 for문인데 모든 전체 중 일부만 처리하는 것
    - $O(n)$ : 단순 for문
...
- 자료구조
    ...
    - 이진 트리 : [노토북](./day04/da02_binary_tree.ipynb)
...
https://github.com/user-attachments/assets/0c3a6db5-c6c2-476f-916e-d4ae96638768
...
- 자료구조/알고리즘
    - 검색 : [노트북](./day08/da01_search.ipynb)
        - 검색 구현 : [파이썬](./day08/da98_sorted_bin_search.py)
    - 코딩테스트
